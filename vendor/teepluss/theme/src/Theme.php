...
class Theme implements ThemeContract
{
    ...
    public function symlink($theme)
    {
        ...
        $link = str_replace($this->getThemeName(), $theme, data_get($trace[1], 'file'));
    ...
    public function symlinkWithFindInherit($theme)
    {
        ...
        $path = str_replace("\\", "/", data_get($trace[1], 'file'));
    ...
    public function getConfig($key = null)
    {
        ...
        return is_null($key) ? $this->themeConfig : data_get($this->themeConfig, $key);
    }
    ...
    public function bind($variable, $callback = null)
    {
        ...
        return data_get($this->bindings, $name, function() use (&$_events, &$_bindings, $name) {
    ...
    public function widget($className, $attributes = array())
    {
        ...
        if (! $instance = data_get($widgets, $className)) {
